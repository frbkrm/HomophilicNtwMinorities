...
It returns a dictionary with keys as time and values as number of minority 
and majority in that time step.
...
if __name__ == '__main__':
    graph = homophilic_barabasi_albert_graph(N = 100, m = 2 , minority_fraction = 0.5, similitude= 0.5)
